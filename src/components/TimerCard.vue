<template>
  <main class="timer-card">
    ...
    <div class="timer-controls">
      <button class="ctrl-btn secondary" title="重置計時 (R)" aria-label="重置" @click="$emit('reset')">
      ...
      <button class="ctrl-btn secondary" title="跳過此階段 (S)" aria-label="跳過" @click="$emit('skip')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
